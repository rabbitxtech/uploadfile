...
export default function Login() {
 ...
 const msg = e.response?.data?.error || t('auth.loginFailed');
 ...
 const msg = e.response?.data?.error || t('auth.verificationFailed');
 toast.error(msg);
 ...
 <span className="text-xl font-semibold">{t('auth.twoFactorCode')}</span>
 </div>
 ...
 <Cloud className="h-7 w-7" />
 <span className="text-xl font-semibold">{t('auth.signIn')}</span>
 </div>
